            ...
            className={
                ...
                ${disabled
                    ...
                    : type === "selectAll"
                        ...
                        : type === "simple"
                            ? "w-12 h-12 flex items-center justify-center bg-point-blue text-white text-2xl font-bold rounded cursor-pointer hover:bg-point-blue/80 disabled:bg-light-gray disabled:cursor-not-allowed"
                            : type === "warning"
