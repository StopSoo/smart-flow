                ...
                <div className="grid grid-cols-2 gap-6 p-6">
                    <div className="flex flex-col min-w-[500px] gap-6">
                        ...
                        <div className="flex flex-row justify-end font-bold text-black">
                            <p>전체: {data?.defectRate.totalCount}건</p>
                        </div>
                        ...
                        <div className="bg-white border-y-2 border-light-gray overflow-hidden">
                            <table className="w-full h-[550px]">
                                ...
                                <tbody>
                                    {
                                        tableData.length !== 0 ?
                                            tableData.slice((currentPage - 1) * Number(itemsPerPage), currentPage * Number(itemsPerPage)).map((item) => (
                                                <tr
                                                    key={item.id}
...

                                    {
                                        Array.from({
                                            length: Math.max(
                                                0,
                                                Number(itemsPerPage) - tableData.slice((currentPage - 1) * Number(itemsPerPage), currentPage * Number(itemsPerPage)).length
                                            )
                                        }).map((_, i) => (
                                            <tr key={`empty-${i}`} className="h-[55px] border-b border-light-gray">
                                                <td colSpan={8}></td>
                                            </tr>
                                        ))
                                    }
                    ...
                    <div className="min-w-[500px] flex flex-col gap-6">
                        ...
                        <div
                            className="h-[510px] border-[4px] border-light-gray bg-soft-white flex items-center justify-center p-6"
                        >
                            {
                        ...
                        <Button
                            ...
                            className="text-lg"
                            onClick={() => router.push(`/processing/process-data/${id}/edit`)}
                        />
                    </div>
                </div>
            </div>
